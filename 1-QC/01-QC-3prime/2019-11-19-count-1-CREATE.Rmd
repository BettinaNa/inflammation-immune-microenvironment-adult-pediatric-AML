...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-12-05/count-20191119_cDNA1" # path to the directory with the outs file
  ...
  sample_name: "2019-11-19-count-1"   # name of the current sample 
  hashtag_ID: ["HTO-AML008",  "HTO-AML028", "HTO-AML038", "HTO-AML043", "HTO-AML056"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["HTO-AML008",  "HTO-AML028", "HTO-AML038", "HTO-AML043", "HTO-AML056"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

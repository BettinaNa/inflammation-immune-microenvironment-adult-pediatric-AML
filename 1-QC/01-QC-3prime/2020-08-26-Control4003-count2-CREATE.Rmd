...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-08-26/count-cDNA2/" # path to the directory with the outs file
  ...
  sample_name: "2020-08-26-Control4003-c2"   # name of the current sample 
  hashtag_ID: ["Healthy_4003_hashtag", "MDS_585_hashtag", "AML_5292_hashtag", "MDS_1123_hashtag", "AML_1540_hashtag"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: "Healthy_4003_hashtag" # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  ...
  sample_names: 
    value:
      Healthy_4003_hashtag: "Control4003"
...
if(!is.null(hashtag_ID)) {
  ...
  if(ADT) {
    # this has an additional hash tag without cells - remove hashtag4

...
output:
  html_document:
    ...
    df_print: paged
params: 
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-09-11/count-cDNA1_09_08/" # path to the directory with the outs file
  ...
  sample_name: "2020-09-11-AML4340_AML1371-c1"   # name of the current sample 
  hashtag_ID: ["HTO1", "HTO2", "HTO3", "HTO4", "HTO5", "HTO6"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["HTO1", "HTO2", "HTO3", "HTO4", "HTO5", "HTO6"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

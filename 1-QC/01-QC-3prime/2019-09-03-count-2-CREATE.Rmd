...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-09-19/count-2-20190903" # path to the directory with the outs file
  ...
  sample_name: "2019-09-03-count-2"   # name of the current sample 
  ...
  hashtags_to_keep: ["CNTRL5",  "4"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-03-18/count-3266/" # path to the directory with the outs file
  ...
  sample_name: "2020-03-18-AML3266"   # name of the current sample 
...
```{r save_rds}
# save final Seurat object
seurat_obj@meta.data$samples <- "AML3266"

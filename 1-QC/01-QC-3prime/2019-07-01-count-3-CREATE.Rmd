...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-07-01/count-3/" # path to the directory with the outs file
  ...
  sample_name: "2019-07-01-count-3"   # name of the current sample 
  hashtag_ID: ["AML0160.1",  "AML0160.2", "AML3133", "AML3762.1", "AML3762.2", "AML0612", "AML0310"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["AML0160.1",  "AML0160.2", "AML3133", "AML3762.1", "AML3762.2", "AML0612", "AML0310"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

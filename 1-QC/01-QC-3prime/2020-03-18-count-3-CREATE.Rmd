...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-03-18/count-Audrey3/" # path to the directory with the outs file
  ...
  sample_name: "2020-03-18-count-3"   # name of the current sample 
  hashtag_ID: ["control_0082",  "AML52-Dx", "AML52-Azacitidine", "AML22-Dx", "AML22-Decitabine"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["control_0082",  "AML52-Dx", "AML52-Azacitidine", "AML22-Dx", "AML22-Decitabine"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  ...
  sample_names: 
    value:
      control-0082: "Control0082"
      AML52-Dx: "AML052"
      AML52-Azacitidine: "NA"
      AML22-Dx: "AML022"
      AML22-Decitabine: "NA"

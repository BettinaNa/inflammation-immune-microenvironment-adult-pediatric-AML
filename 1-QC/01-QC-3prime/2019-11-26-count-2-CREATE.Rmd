...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-12-05/count-20191126_cDNA2" # path to the directory with the outs file
  ...
  sample_name: "2019-11-26-count-2"   # name of the current sample 
  hashtag_ID: ["HTO-AML003",  "HTO-AML006", "HTO-AML025", "HTO-AML073"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["HTO-AML003",  "HTO-AML006", "HTO-AML025", "HTO-AML073"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

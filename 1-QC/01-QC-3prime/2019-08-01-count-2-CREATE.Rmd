...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-08-01/count-2/" # path to the directory with the outs file
  ...
  sample_name: "2019-08-01-count-2"   # name of the current sample 
  hashtag_ID: ["CNTRL1",  "CNTRL2", "CNTRL3", "CNTRL4", "TALL3783", "TALL3862", "ETP9153"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["CNTRL1",  "CNTRL2", "CNTRL3", "CNTRL4"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

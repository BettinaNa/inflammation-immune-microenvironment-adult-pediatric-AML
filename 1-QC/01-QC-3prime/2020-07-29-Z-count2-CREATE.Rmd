...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-07-29/count-cDNA_2_ZS/" # path to the directory with the outs file
  ...
  sample_name: "2020-07-29-AML2123-c2"   # name of the current sample 
  hashtag_ID: ["hashtag1_human", "hashtag2_human", "hashtag3_human", "hashtag4_human"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["hashtag1_human", "hashtag2_human", "hashtag3_human", "hashtag4_human"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
...
if(!is.null(hashtag_ID)) {
  ...
  if(ADT) {
    # this has additional hash tag without cells - remove mouse hashtags
    hash_idx <- 1:8

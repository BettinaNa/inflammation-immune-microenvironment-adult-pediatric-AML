...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-01-03/count-3prime_2" # path to the directory with the outs file
  ...
  sample_name: "2020-01-03-count-2"   # name of the current sample 
  hashtag_ID: ["AML-005",  "AML-012", "AML-033", "AML-048", "AML-055"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["AML-005",  "AML-012", "AML-033", "AML-048", "AML-055"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

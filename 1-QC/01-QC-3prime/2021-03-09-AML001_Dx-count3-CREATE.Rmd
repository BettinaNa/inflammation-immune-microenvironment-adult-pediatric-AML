...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2021-03-09/count-Audrey_cDNA3/" # path to the directory with the outs file
  ...
  sample_name: "2021-03-09-AML001_Dx-count3"   # name of the current sample 
...
```{r save_rds}
# save final Seurat object
seurat_obj@meta.data$samples <- "AML001"

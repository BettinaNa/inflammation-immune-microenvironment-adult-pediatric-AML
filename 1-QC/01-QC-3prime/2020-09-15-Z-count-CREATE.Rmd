...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2020-09-15/count-cDNA/" # path to the directory with the outs file
  ...
  sample_name: "2020-09-15-AML0024"   # name of the current sample 
  hashtag_ID: ["HTO1", "HTO2"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["HTO1", "HTO2"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

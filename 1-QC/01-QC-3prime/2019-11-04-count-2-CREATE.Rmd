...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-11-04/count-2/" # path to the directory with the outs file
  ...
  sample_name: "2019-11-04-count-2"   # name of the current sample 
  hashtag_ID: ["Healthy_0058", "Healthy_0059", "PAXMIJ_D", "PAXMIJ_EoT", "PAXMIJ_Relapse", "PAUMTZ_D", "PAUMTZ_EoT", "PAUMTZ_Relapse"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["Healthy_0058", "Healthy_0059", "PAXMIJ_D", "PAUMTZ_D"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  ...
  sample_names: 
    value:
      Healthy-0058: "Control0058"
      Healthy-0059: "Control0058"
      PAXMIJ-D: "PAXMIJ"
      PAUMTZ-D: "PAUMTZ"

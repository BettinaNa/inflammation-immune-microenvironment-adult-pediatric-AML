...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/sequence/results/aifantislab/2021-runs/2021-03-09/cellranger2/count-AML_3948/" # path to the directory with the outs file
  ...
  sample_name: "2021-03-09-AML3948"   # name of the current sample 
...
```{r save_rds}
# save final Seurat object
seurat_obj@meta.data$samples <- "AML3948"

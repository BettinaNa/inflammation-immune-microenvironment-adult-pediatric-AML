...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-09-19/count-2-20190829" # path to the directory with the outs file
  ...
  sample_name: "2019-08-29-count-2"   # name of the current sample 
  hashtag_ID: ["CNTRL5",  "2", "3", "4", "5", "TALL4954"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["CNTRL5",  "2", "3", "4", "5"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
...
if(!is.null(hashtag_ID)) {
  ...
  if(ADT) {
    # we have additional hashtag 7 - fix here
    hash_idx <- 1:7

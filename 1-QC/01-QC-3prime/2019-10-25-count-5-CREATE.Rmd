...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/CITEseq_cellranger_v5/2019-10-25/count-5/" # path to the directory with the outs file
  ...
  sample_name: "2019-10-25-count-5"   # name of the current sample 
  hashtag_ID: ["Healthy_0004",  "AML_0656", "AML_1552", "AML_2451"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["Healthy_0004",  "AML_0656", "AML_1552", "AML_2451"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/TCR_seq_v6/2020-08-07/multi-MDS-AML_cDNA1/" # path to the directory with the outs file
  ...
  sample_name: "2020-08-07-MDS-AML_cDNA1"   # name of the current sample 
  hashtag_ID: ["hashtag1", "hashtag2", "hashtag3", "hashtag4", "hashtag5"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: "hashtag5" # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

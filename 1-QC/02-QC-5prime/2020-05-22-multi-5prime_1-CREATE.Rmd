...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/TCR_seq_v6/2020-05-22/multi-5prime_1/" # path to the directory with the outs file
  ...
  sample_name: "2020-05-22-5prime_1"   # name of the current sample 
  ...
  hashtags_to_keep: "hashtag1" # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)

...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/nadorb01/TCR_seq_v6/2020-10-06/multi-5prime_cDNA5/" # path to the directory with the outs file
  ...
  sample_name: "2020-10-06-5prime_cDNA5"   # name of the current sample 
  hashtag_ID: ["hashtag1", "hashtag2", "hashtag3"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
  hashtags_to_keep: ["hashtag1", "hashtag2", "hashtag3"] # names of the hashtags to keep (if the hashtags are NOT separate from the gene expression data)
